...
seo:
  ...
  description: >-
    How an AI content company used Astro and Netlify's on-demand builders to enable users to share
    their generated blog posts with each other - all in one month.
coverGradientFrom: '#6CE486'
coverGradientTo: '#4783B5'
publishDate: June 29, 2023
authors:
  - astro-team
lang: en
socialImage: /src/content/caseStudies/_images/contenda-share-pear/social-image.webp
coverImage: /src/content/caseStudies/_images/contenda-share-pear/cover-image.webp
headerImage: /src/content/caseStudies/_images/contenda-share-pear/header.webp

---

import screenshot1 from "./\_images/contenda-share-pear/screenshot1.webp"
import screenshot2 from "./\_images/contenda-share-pear/screenshot2.webp"
import videosToContent from "./\_images/contenda-share-pear/videos-to-content.webp"
...
<ImageFigure caption="Contenda’s blog post preview share feature">
  <BlogContentImage src={screenshot2} />
</ImageFigure>
